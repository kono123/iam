...
/*****************************************************************************/
        ...
        #include "rtc.h"
	#define time_getYear(void) RTC_getYear()
	#define time_getMonth(void) RTC_getMonth()
	#define time_getDay(void) RTC_getDay()
	#define time_getHour(void) RTC_getHour()
	#define time_getMinute(void) RTC_getMinute()
	#define time_getSecond(void) RTC_getSecond()
