 ...
 *          to avoid alignment problems (or at least warnings)
 *          with ARM controllers and GNU arm-elf toolchain.
*/
//	#define EFSL_ATTR_PACKED __attribute__((packed)) /* ARM */
...
*/
	...
	/*#define IOMAN_NUMBUFFER 6 ; 64kB RAM on the AT91SAM7S256 - let's use 3 kB */
